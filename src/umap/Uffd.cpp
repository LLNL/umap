...
namespace Umap {
  ...
  void Uffd::copy_in_page(char* data, void* page_address) {
  ...
  void Uffd::copy_in_page_and_write_protect(char* data, void* page_address) {
