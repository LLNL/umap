...
namespace Umap {
  ...
  class StoreNetwork : public Store {
    ...
    public:
      StoreNetwork(void* _region_, size_t _rsize_, size_t _alignsize_, NetworkEndpoint* _endpoint_);
    ...
    private:
      ...
      std:vector<struct ibv_mr *> remote_mem_regions;
