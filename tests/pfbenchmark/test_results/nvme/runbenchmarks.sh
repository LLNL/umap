...
do
  ...
  do
    ...
    #drop_page_cache
    echo nvmebenchmark -b $buffersize -p $numpages -t $i -f /mnt/intel/pfbench --directio -u $j
    time nvmebenchmark -b $buffersize -p $numpages -t $i -f /mnt/intel/pfbench --directio -u $j
