...
/*
* Partially modified by Iwabuchi, Keita on 10/31/17.
* (changed namespace name and the include file)
*/

#ifndef UTILITY_HASH_HPP
#define UTILITY_HASH_HPP
